    ...
    return Def.ActorFrame{
        Def.ActorFrame{ --Fever meter
                ...
                FeverScoreMessageCommand=function(self,params)
                    ...
                    if not self.Active then
                        if params.Amount >= 50 then 
                            self:diffuseshift():effectcolor1(color(PalladiumQuantumColorTable["Fever"])):effectcolor2(1,1,1,1):effectperiod(.5)
                        else 
            ...
            Def.Sprite{
                ...
                Texture='sprites/feveroverlay.png'
            },
        ...
        Def.ActorFrame{ --Highway
            ...
            Def.Quad{ --Highway edges
                ...
                FeverMessageCommand=function(self,params)
                    if params.pn ~= sPlayer then return end
                    if params.Active then
                        self:diffuse(color(PalladiumQuantumColorTable["Fever"])):diffusetopedge(Alpha(color(PalladiumQuantumColorTable["Fever"]),0))
                    else
            ...
            Def.ActorFrame{ --Fever effects
                ...
                Def.Sprite{
                    ...
                    InitCommand=function(self)
                        self:x(-102):diffuse(color(PalladiumQuantumColorTable["Fever"])):zoom(4)
                    end
                },
                Def.Sprite{
                    Texture="sprites/feversprite1.png",
                    InitCommand=function(self)
                        self:x(102):zoomx(-4):zoomy(4):diffuse(color(PalladiumQuantumColorTable["Fever"]))
                    end
                },
                FeverMessageCommand=function(self,params)
                    if params.pn ~= sPlayer then return end
            ...
            Def.ActorFrame{ --More fever effects
                ...
                Def.Quad{
                    InitCommand=function(self)
                        self:x(-150):zoomto(32,940):diffuse(Alpha(color(PalladiumQuantumColorTable["Fever"]),0)):diffuselowerleft(color(PalladiumQuantumColorTable["Fever"]))
                    end
                },
                Def.Quad{
                    InitCommand=function(self)
...
local Push = Def.ActorFrame{
    Def.Model {
        InitCommand=function(self)
            self:rotationx(90):diffuse(color(PalladiumQuantumColorTable["192nd"]))
        ...
        FeverMessageCommand=function(self,params)
            ...
            if params.Active then
                ...
                self:diffuse(color(PalladiumQuantumColorTable["192nd"]))
            end
    ...
    Def.Model {
        InitCommand=function(self)
            self:diffuse(color(PalladiumQuantumColorTable["192nd"])):diffusealpha(0):rotationx(90):rotationy(120 + offsetChart[sButton]):zoom(1.01)
...
return Def.ActorFrame {
    ...
    Def.Model {
        InitCommand=function(self) self:rotationx(90):diffuse(color(PalladiumQuantumColorTable["192nd"])):zoom(0.99) end,
