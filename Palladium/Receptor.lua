...
local Push = Def.ActorFrame{
    ...
    Def.Model {
        InitCommand=function(self)
            self:diffuse(color(PalladiumColorTable[sButton])):diffusealpha(0):rotationx(90):rotationy(120 + offsetChart[sButton]):zoom(1.01)
...
return Def.ActorFrame {
    ...
    Def.Model {
        InitCommand=function(self) self:rotationx(90):diffuse(color(PalladiumColorTable[sButton])):zoom(0.99) end,
